...
R Markdown dokumentti joka kerää yhteen alustavat analyysit Kunta10 kehittämistoimenpiteitten kirjaamisen tutkimisesta. Alussa käydään läpi taustamuuttujien jakauma kirjanneiden ja ei-kirjanneiden työykisköiden välillä. Tämä on tehty siitä huolimatta että emmä pysty määrittämään olisiko työykiskön pitänyt kehittämistoimenpiteitä kirjata vai ei. Mutta emme pysty analysoimaan mikä määrittää työyksikön, tai mitkä ovat sen tyyppi piirteitä jollei meillä ole verrokkiryhmää (mun ajatusmoka viime kokouksessa, sori)

Sitten seuraavaksi katsomme miten neljä eniten valittun kehittämistoimenpiteen alkuperäiset arvot jakautuvat kirjanneiden ja ei-kirjanneiden välillä.

kolmanneksi katsomme oliko 'liikennevaloilla' oikeasti merkitystä kehittämistoimenpiteitä valittaessa. Ja viimeksi LASSO (Least Absolute Shrinkage Selector Operator), regression arvioimaan että mitkä muuttujan parhaiten ennustavat kehittämistoimenpiteen valintaa. (Lasso regression analysis is a shrinkage and variable selection method for linear regression models. The goal of lasso regression is to obtain the subset of predictors that minimizes prediction error for a quantitative response variable. The lasso does this by imposing a constraint on the model parameters that causes regression coefficients for some variables to shrink toward zero. Variables with a regression coefficient equal to zero after the shrinkage process are excluded from the model. Variables with non-zero regression coefficients variables are most strongly associated with the response variable)
...
Koko aineiston kaikkien työyksiköiden jakaumat taustamuuttujittain verraten työyksiköitä jotka kirjasivat kehittämistoimenpiteitä, ja niitä jotka eivät niin tehneet
...
s_dat2$kehto_l <- factor(s_dat2$kehto,levels=c(0,1),
                      labels=c("ei merkitöjä","merkintöjä")) 
qplot(M63, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="keskikä", xlab="Työntekijöiden keski-ikä",
      ylab="Density")
summary(s_dat2$M63)
summary(k_dat2$M63)
...
qplot(M65, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Määräaikaisten osuus", xlab="Määräaikaisten osuus",
      ylab="Density")
summary(s_dat2$M65)
summary(k_dat2$M65)

qplot(saajia, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Työpaika koon mukaan", xlab="Työpaika koko",
      ylab="Density")
...
Seuraavaksi neljän tärkeimmän muuttujan jakaumat sekä kehtolaisille että muille

```{r, echo=FALSE}
# Kernel density plots for kehto
# grouped by kehto (indicated by color)
s_dat2$kehto_l <- factor(s_dat2$kehto,levels=c(0,1),
                      labels=c("ei merkintöjä","merkintöjä")) 
qplot(m3, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Työnhallinta", xlab="Työnhallinta",
      ylab="Density")
...
qplot(m54, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Väkivalta asiakkailta", xlab="Väkivalta asiakkailta",
      ylab="Density")
...
qplot(m18, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Työyhteisötaidot: auttaminen ja huomaavaisuus", xlab="Työyhteisötaidot: auttaminen ja huomaavaisuus",
      ylab="Density")
...
qplot(m23, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Työpaikan ilmapiiri", xlab="Työpaikan ilmapiiri",
      ylab="Density")
...
qplot(m4, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Työpaineita paljon, hallintaa vähän", 
      ylab="Density")
...
qplot(m20, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Työyhteisötaidot: tavoitteellisuus", 
      ylab="Density")
...
qplot(m21, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Työyhteisötaidot: kehittäminen", 
      ylab="Density")
...
qplot(m22, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Työyhteisön tuki esimiehelle", 
      ylab="Density")
...
qplot(m34, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Päätöksenteon oikeudenmukaisuus", 
      ylab="Density")
...
qplot(m35, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Yksilökehityskeskustelun käyminen", 
      ylab="Density")
...
qplot(m36, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Yksilökehityskeskustelun hyödyllisyys", 
      ylab="Density")
...
qplot(m38, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Kehityskeskustelun sisältö: uudet tavoitteet", 
      ylab="Density")
...
qplot(m39, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Kehityskeskustelun sisältö: kehittymismahdollisuudet", 
      ylab="Density")
...
qplot(m41, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Kehityskeskustelun sisältö: mielipiteen ilmaisumahdollisuus", 
      ylab="Density")
...
qplot(m42, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Kehityskeskustelun sisältö: odotukset työssä", 
      ylab="Density")
...
qplot(m43, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Kehityskeskustelun sisältö: kehittymissuunnitelma", 
      ylab="Density")
...
qplot(m44, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Ryhmäkehityskeskustelun käyminen", 
      ylab="Density")
...
qplot(m45, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Ryhmäkehityskeskustelun hyödyllisyys", 
      ylab="Density")
...
qplot(m46, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Yksilö- ja/tai ryhmäkehityskeskustelun käyminen", 
      ylab="Density")
...
qplot(m13, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Täydennyskoulutus riittävä", 
      ylab="Density")
...
qplot(m49, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Muutokset työssä: ei vaikutusmahdollisuuksia", 
      ylab="Density")
...
qplot(m14, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Halu jatkaa omassa työssä", 
      ylab="Density")
...
qplot(m57, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Uskoo jatkavansa eläkeikään saakka", 
      ylab="Density")
...
qplot(m15, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Harkinnut eläkkeelle jäämistä", 
      ylab="Density")
...
qplot(m16, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Harkinnut työnantajan vaihtamista", 
      ylab="Density")
...
qplot(m17, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="Työnantajan suositteleminen", 
      ylab="Density")
...
qplot(m52, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="K10-tulosten pohjalta tehty toimenpiteitä", 
      ylab="Density")
...
qplot(m53, data=s_dat2, geom="density", fill=kehto_l, alpha=I(.5),
      main="K10-tulosten pohjalta tehtyjä toimenpiteitä seurattu", 
      ylab="Density")
...
Ylläolevosta kuvista ei voi tarkasti sanoa millä muuttujilla on merkittävä ero merkanneiden ja ei merkanneiden työyhteisöjen välillä (paitsi ehkä osassa kehityskeskustelu kuvissa). Joten olen myös laskenut t-testit kaikille muuttujille, joissa arvioidaan merkittävää eroa merkinneiden ja ei merkinneiden työyhteisöjen välillä.

Alla oleva lista näyttää listan vain muuttujista joilla ryhmien välillä on tilastollisesti merkittävä ero. Muuttujia joilla ei merkittävää eroa ei löytynyt ei ole printattu tähän.
...
Liikennevalojen jakauma työyksiköissä on suhteellisen laaja. Suuri osa työykisköistä ei saa yhtään huomioväriä, kun taas punaisten huomiovärejen maksimi on 30 (huom tässä muutosta viime kerrasta, sillä tajusin että puuttuvat arvot olivat tasan olevia raja-arvoja).

Alempi histrogrammi kuvaa vihreiden huomiovärien jakaumaa. Vihreissä huomioväreissä on myös suuri jaukauma. Maksimissaan työyksikkö on saanut 21 vihreetä huomioväriä kun taas osalla ei ole yhtään huomioväriä. 
...
Sekä vihreillä ja punaisilla huomioväreillä on pareto jakauma. 

### Liikennevalojen jakauma kehdon tekijöiden ja tekemättömien välillä

Jakauma on suhteellisen samanlainen sekä koko aineistolle että, työyksiköille jotka tekivät kehittämistoimenpiteitä
...
### Todennäköisyys valita liikennevaloihin perustuen

Neljän eniten valitun kehittämiskohteen todennäköisyys tulla valituksi liikennevalon perusteella.Ensin tarkastellaan punaisia liikennevaloja, ja sen jälkeen vihreitä liikennevaloja

#### Punaiset liikennevalot

Alla olevassa analyysissa tarkastellaan vain työyksiköitä joilla on ainakin yksi punainen liikennevalo.

Huomio: 
*M3 = Työn hallinta
*M54 = Väkivalta asiakkailta
*M18 = Työyhteisötaido: auttaminen ja huomaavaisuus
*M23 = Työpaika ilmapiiri
...
Alla olevassa analyysissa tarkastellaan vain työyksiköitä joilla on ainakin yksi vihreä liikennevalo.
...
```
Myös vihreillä liikennevaloilla on merkityksellinen suhde kehittämiskohteiden valinnassa. Mutta vain työnpaikan ilmapiirissä olivat työnyhteisöt suuremmalla todennälöisyydellä valitsivat tämän kehittämiskohteeksi. 

Kun katsoo kaikkia kehittämistoimenpiteitä ja niihin liittyviä liikennevaloja, voi huomata että on myös liikennevaloja joilla ei ole tilastollisesti merkittävää suhdetta kehittämistoimenpiteeksi valitsemisen kanssa. 


## Kehittämistoimenpide ja muuttujan taso

Alla tarkasttellaan työyhteisöjen todennäköisyyttä valita kehittämistoimenpide ja kyseessä olevan muuttujan tason suhdetta.

Alle olen tehnyt mallit kaikista muuttujista. Olen tulostanut jokaisesta mallista vain interceptin ja OR:t, sekä 95% luottamusvälit. 

Ei kannata huolestua jos jollein muuttujille on todella korkeita lukuja. Sillä lukuhan kertoo sitä että 'yhden asteen nousu vaikuttaa..'. Joissain muuttujissa on todella kapea jakauma, ja keskiarvossa yhden asteen muutos olisi todella huima. 
...
Näistä tuloksista pystyy päättelemään missä muuttujissa on tilastollisesti merkittävä suhde, mihin suuntaan suhde toimii ja miten se käytännössä toimii. Kuitenkin on vaikea verrata muuttujia toisiinsa, sillä muuttujat oimivat eri skaaloilla. 

## Kehittämistoimenpide ja muuttujan taso -- normalisoituna

Alla tarkasttellaan työyhteisöjen todennäköisyyttä valita kehittämistoimenpide ja kyseessä olevan muuttujan tason suhdetta.

Alle olen tehnyt mallit kaikista muuttujista. Olen tulostanut jokaisesta mallista vain interceptin ja OR:t, sekä 95% luottamusvälit. 

Alla olevat laskelmat ovat identtiä yllä oleviin, ainoa ero on että data on normalisoitu. Eli muuttujien mean on 0 ja standard deviaatio on 1. 
...
Lasso-regressiota ei voi tehdä puuttuvien arvojen kanssa. Tämä on sinäänsä ongelma, koska joillakin työpaikoilla on puuttuvia arvoja. Myöskään nämä puuttuvat arvot eivät esiinny satunnaisesti vaan ovat yleensä tietyntyyppisten (kokoisten työpaikkojen ongelma). Tämä analyysi on vielä vahvasti kesken,ja tulokset ovat vain alustavasti suuntaa antavia

### Työyhteisötaidot: auttaminen ja huomaavaisuus
Alla oleva Lasso on tehty datalla josta puuttuvat arvot ovat poistettu. Lopussa oleva malli on Lasson optimoima regressiomalli jos mallennetaan Työyhteisötaidot: auttaminen ja huomaavaisuus valitsemista kehittämiskohteeksi
